...
+(SecKeyRef) getPublicKeyRefrence
{
     NSData *derData = [[NSData alloc] initWithContentsOfFile:@""];
...
+ (NSData *)encryptData:(NSData *)data withKeyRef:(SecKeyRef) keyRef{
    ...
    //NSData *derData = [[NSData alloc] initWithContentsOfFile:HSD_RB_pubKeyUrl];
...
+ (NSData *)encryptMyData:(NSData *)data
{
    
    SecKeyRef keyRef = [RSA getPublicKeyRefrence];
    const uint8_t *srcbuf = (const uint8_t *)[data bytes];
    size_t srclen = (size_t)data.length;
